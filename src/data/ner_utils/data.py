...
def create_data_for_subtask_1(output_directory):
    ...
    training_directory = os.path.join(directory, 'training_valid_test_background_multilingual/training')
    ...
    valid_directory = os.path.join(directory, 'training_valid_test_background_multilingual/valid')
